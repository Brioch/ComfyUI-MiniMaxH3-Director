    ...
    if (nodeData.name === "MiniMaxH3DirectorCS") {
      ...
      nodeType.prototype.onNodeCreated = function () {
        ...
        const _mmxBuildSettingsPanel = (node, panelRoot) => {
          ...
          // a 480 short edge. Nothing here goes past native: a canvas outside the trained
          // envelope costs time and memory for it, so it is something to type rather than
          // something to reach for by name.
          const RES = [
